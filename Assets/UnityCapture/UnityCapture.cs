...
public class UnityCapture : MonoBehaviour
{
    ...
    [SerializeField] [Tooltip("Scale image if Unity and capture resolution don't match (can introduce frame dropping, not recommended)")] public EResizeMode ResizeMode = EResizeMode.LinearResize;
    ...
    public class Interface
    {
        ...
        public ECaptureSendResult SendTexture(Texture Source, int Timeout = 1000, bool DoubleBuffering = false, EResizeMode ResizeMode = EResizeMode.LinearResize, EMirrorMode MirrorMode = EMirrorMode.Disabled)
        {
